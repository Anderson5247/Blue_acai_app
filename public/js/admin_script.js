...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function populateShopStatus(shopInfo) {
        ...
        if (shopInfo.deliveryLocations) {
            if (deliveryCedralToggle) deliveryCedralToggle.checked = shopInfo.deliveryLocations.cedral;
            if (deliveryOuteiroToggle) deliveryOuteiroToggle.checked = shopInfo.deliveryLocations.outeiro;
        }
